...
impl Default for NodeMetrics {
    fn default() -> Self {
        Self {
            ema_latency_ms: 1000.0, // starts pessimistic
            success_count: 1, // seed with 1 to avoid /0
            total_count: 1,
            last_slot: 0,
        }
    }
...
/// Async RPC wrapper with exponential backoff retries and intelligent load balancing.
pub struct Fetcher {
...
impl Fetcher {
    ...
    fn best_node(&self, attempt: u32) -> &RpcNode {
        // Find global max slot to calculate lag penalties
        ...
        // Select the nth best node (fallback to lower scores on retries)
